  ...
  return (
    <div id="student-portofolio" className="mb-5">
      <Container className="px-5">
        ...
        {/* List Portfolio */}
        <Row>
          {filteredData?.slice(0, 12).map((data) => (
        ...
        <div className="text-center mt-5">
          <Link to="/list-portfolio" className="text-decoration-none fw-semibold fs-5 fst-italic text-black link-hover">
            See More E-Portfolio ...
          </Link>
        </div>
      </Container>
    </div>
